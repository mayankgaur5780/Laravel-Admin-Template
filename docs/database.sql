...
MySQL - 10.3.23-MariaDB-1:10.3.23+maria~bionic-log : Database - laravel-template
*********************************************************************
*/
...
(1,1,'Admin','20180622153757LRM6xCxZVW.jpg','91','1234567890','admin@demo.com','$2y$10$S.NJVoe6WxO7ZiuxtbSmze7qp0tIkDnuQ7dS/js2Ky44FwZCzMAfy','0idzKi2rwwny7azeAQ135ahgjX0Ni8PYbSUXRLGROf5gkQSCwlTG9CkmLHqT',NULL,1,'2018-04-23 14:38:00','2019-06-27 10:34:23'),
...
insert  into `settings`(`id`,`label`,`attribute`,`value`,`created_at`,`updated_at`) values 
(1,'Tax Percentage','tax_percentage','5','2020-07-04 13:40:25','2020-07-04 08:10:32');
