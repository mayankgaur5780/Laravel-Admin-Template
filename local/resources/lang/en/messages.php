...
return [
    ...
    "total_subscriptions_amount" => "Total Subscriptions Amount",
    ...
    "apply" => "Apply",
    "cancel" => "Cancel",
    "no_of_subscriptions" => "No of subscriptions",
    ...
    'subscription_days' => [30 => "One Month", 180 => "Six Month", 365 => "One Year", 0 => "Unlimited"],
