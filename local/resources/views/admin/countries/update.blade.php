                ...
                <div class="box-body">
                    ...
                    <form id="save-frm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="country_name" placeholder="{{ transLang('name') }}" value="{{ $country->country_name }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label required">{{ transLang('en_name') }}</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="en_country_name" placeholder="{{ transLang('en_name') }}" value="{{ $country->en_country_name }}">
                            </div>
                        </div>
                        <div class="form-group">
        ...
        $(document).on('click','#saveBtn',function(e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        window.location.replace('{{ route("admin.countries.index")}}');
                    }
                });
            });
        });
