...
@section('title') {{ transLang('reset_password') }}
@endsection
                ...
                <div class="box-body">
                    ...
                    <form id="resetPassword-form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="new_password" class="col-sm-2 control-label received">{{ transLang('new_password') }}</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="password_confirmation" class="col-sm-2 control-label received">{{ transLang('confirm_password') }}</label>
                            <div class="col-sm-6">
