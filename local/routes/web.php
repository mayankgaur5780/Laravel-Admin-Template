...
Route::group(['namespace' => 'Admin', 'middleware'=>'detect.admin.locale'], function () {
    Route::get('/', [
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware'=>'detect.admin.locale'], function () {
    Route::get('/', [
        'uses' => 'AuthController@getLogin',
        'as' => 'login'
    ]);
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => ['admin.auth', 'detect.admin.locale']], function () {
